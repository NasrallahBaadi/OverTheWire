...
def getpass(url, user, password, proxies=None):
    ...
    print(f"[+] The password of natas8 is: {passwd}")

def main():
    # Parse command-line arguments
    parser = argparse.ArgumentParser(description="Grabs the password of natas8 by exploiting an LFI.")
    parser.add_argument('-p', '--password', help='Password of natas7.', required=True, metavar='Password')
