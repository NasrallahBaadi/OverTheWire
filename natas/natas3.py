...
def getpass(url, user, password, proxies=None):
    ...
    print(f"[+] The password of natas4 is: {passwd}")

def main():
    # Parse command-line arguments
    parser = argparse.ArgumentParser(description="Grabs the password of natas4 from a text file located in the secret directory found in robots.txt file.")
    parser.add_argument('-p', '--password', help='Password of natas3.', required=True, metavar='Password')
