...
def getpass(url, user, password, proxies=None):
    ...
    print(f"[+] The password of natas11 is: {passwd}")

def main():
    # Parse command-line arguments
    parser = argparse.ArgumentParser(description="Grabs the password of natas11 by exploiting a command injection vulnerability to read the password file.")
    parser.add_argument('-p', '--password', help='Password of natas10.', required=True, metavar='Password')
